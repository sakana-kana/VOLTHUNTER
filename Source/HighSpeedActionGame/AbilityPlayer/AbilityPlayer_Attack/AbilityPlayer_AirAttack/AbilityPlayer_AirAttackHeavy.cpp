...
//UAbilityPlayer_AirAttackHeavy::UAbilityPlayer_AirAttackHeavy()
//{
//	// 同じAbilityの重複発動禁止
//	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
//	StateTag = FGameplayTag::RequestGameplayTag(FName("State.Attack.Heavy.1.Air"), false);
//
//}
//
//void UAbilityPlayer_AirAttackHeavy::InitializeTags()
//{
